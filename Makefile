srcdir = /home/niansong/Downloads/php-5.5.30/ext/jieba
builddir = /home/niansong/Downloads/php-5.5.30/ext/jieba
top_srcdir = /home/niansong/Downloads/php-5.5.30/ext/jieba
top_builddir = /home/niansong/Downloads/php-5.5.30/ext/jieba
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-php-config=/opt/php/bin/php-config'
CONFIGURE_OPTIONS = '--with-php-config=/opt/php/bin/php-config'
...
AWK = nawk
JIEBA_SHARED_LIBADD =
shared_objects_jieba = jieba.lo
PHP_PECL_EXTENSION = jieba
PHP_MODULES = $(phplibdir)/jieba.la
PHP_ZEND_EX =
...
prefix = /opt/php
phplibdir = /home/niansong/Downloads/php-5.5.30/ext/jieba/modules
phpincludedir = /opt/php/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
PHP_EXECUTABLE = /opt/php/bin/php
EXTRA_LDFLAGS = -lstdc++
EXTRA_LIBS =
INCLUDES = -I/opt/php/include/php -I/opt/php/include/php/main -I/opt/php/include/php/TSRM -I/opt/php/include/php/Zend -I/opt/php/include/php/ext -I/opt/php/include/php/ext/date/lib -I/usr/local/include
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
